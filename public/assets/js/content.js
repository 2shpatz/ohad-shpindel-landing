  ...
  projects: [
    {
      ...
      imageFit: 'contain',
      imageBg: '#0e0a14',
      summary: 'בקיצור...\nזמן הוא משאב חשוב ביותר שאין לנו הרבה ממנו!\n המטרה היא לחסוך למטפלת המון זמן בכל מה שמעבר למפגשי הטיפול, לסייע בניהול המשפחות ותיעוד התהליך, להגביר את המוערבות וההתמדה של ההורים\nואיך לא?... שכבה בסיסית נדיבה ביותר לגמרי בחינם!',
      body: [
        ...
        'שפכו ת\'לב -  Spill It Out\nעוזרת לך לעשות את זה במהירות בקלות, באופן מרהיב ובמגוון דרכים!\nנותנת לך תמונה מלאה על התהליך באמצעות גרפים ושומרת אותך תמיד בעניינים.',
        ...
        columns: [
          ...
          },
          {
            ...
            items: [
              ...
              'גישה לקבוצת הוואטסאפ הפרטית של Spill-It-Out עם מענה מהיר לכל בעיה',
