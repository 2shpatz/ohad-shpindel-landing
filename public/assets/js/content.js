...
const SITE_CONTENT = {
  ...
  projects: [
    {
      id: 'spill-it-out',
      // Blank line = subtitle break; the single newline splits the headline
      // itself over two lines so the Hebrew and Latin names each get one.
      ...
      body: [
        ...
        '🖥️ התוכנה בעברית ובאנגלית, מתואמת למערכת הפעלה ווינדווס Windows.\n🔒 מותקנת מקומית על המחשב (ולא ברשת), עם אפשרות שימוש במנוע בינה מלאכותית (AI) מקומי או חיצוני עם הסתרה של פרטי הלקוחות לשמירה מקסימלית על חיסיון המידע של התהליכים.',
        ...
        columns: [
          ...
          },
          {
            ...
            items: [
              ...
              'הפקת דוחות להורים - במסלולי הדרכת ההורים והשינה, בהתאמה למותג שלך',
      ...
      reportSamples: [
        {
          label: 'הורות',
          file: 'assets/files/reports/parenting-report-example.html',
          description: 'דוח לדוגמה להדרכת הורים',
        },
        {
          label: 'שינה',
          file: 'assets/files/reports/sleep-report-example.html',
          description: 'דוח לדוגמה לייעוץ שינה',
        },
      ],
    ...
    options: [
      {
         ...
         * code that follows it (.../50ILS). Delete this whole block and the
         ...
         *
         * Both links are /pay, our own path, NOT paypal.me — see public/_redirects
         * for why. Short version: the PayPal app claims every paypal.me path as
         * an app link, so a direct link never reaches the web page on a phone;
         * it opens the app, which drops the amount. Going through a 302 keeps
         * the navigation in the browser, where the amount does work. */
        amounts: {
